    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            <div class="nav">
                ...
                <form class="app_form" action="{{ route('processos.store') }}" method="post"
                        ...
                        <div id="data">
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="em_servico" class="select2">
                                        <option value="sim" {{ (old('em_servico') == 'sim' ? 'selected' : '') }}>Sim
                                        </option>
                                        <option value="não" {{ (old('em_servico') == 'não' ? 'selected' : '') }}>Não
                                        </option>
                                    </select>
                                </label>
                                <label class="label">
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <input type="text" name="processo_de_execucao" placeholder="Processo"
                                           class="processo-execucao"
                                ...
                                <label class="label">
                                    ...
                                    <select name="regime" class="select2">
                                        <option value="Aberto" {{ (old('regime') == 'Aberto' ? 'selected' : '') }}>
                                            Aberto
                                        </option>
                                        <option value="Fechado" {{ (old('regime') == 'Fechado' ? 'selected' : '') }}>
                                            Fechado
                                        </option>
                                        <option
                                            value="Integralmente Fechado" {{ (old('regime') == 'Integralmente Fechado' ? 'selected' : '') }}>
                                            Integralmente Fechado
                                        </option>
                                        <option value="Multa" {{ (old('regime') == 'Multa' ? 'selected' : '') }}>Multa
                                        </option>
                                        <option
                                            value="Semiaberto" {{ (old('regime') == 'Semiaberto' ? 'selected' : '') }}>
                                            Semiaberto
                                        </option>
                                    </select>
                                </label>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="sit_processual" class="select2">
                                        <option
                                            value="Condenado" {{ (old('sit_processual') == 'Condenado' ? 'selected' : '') }}>
                                            Condenado
                                        </option>
                                        <option
                                            value="Flagrante" {{ (old('sit_processual') == 'Flagrante' ? 'selected' : '') }}>
                                            Flagrante
                                        </option>
                                        <option
                                            value="Medida de Internacao" {{ (old('sit_processual') == 'Medida de Internacao' ? 'selected' : '') }}>
                                            Medida de Internacao
                                        </option>
                                        <option
                                            value="Medida de Segurança" {{ (old('sit_processual') == 'Medida de Segurança' ? 'selected' : '') }}>
                                            Medida de Segurança
                                        </option>
                                        <option
                                            value="Preventiva" {{ (old('sit_processual') == 'Preventiva' ? 'selected' : '') }}>
                                            Preventiva
                                        </option>
                                        <option
                                            value="Temporaria" {{ (old('sit_processual') == 'Temporaria' ? 'selected' : '') }}>
                                            Temporaria
                                        </option>
                                        <option
                                ...
                                <label class="label">
                                    ...
                                    <select name="reincidencia" class="select2">
                                        <option
                                            value="Primario" {{ (old('reincidencia') == 'Primario' ? 'selected' : '') }}>
                                            Primario
                                        </option>
                                        <option
                                            value="Reincidente" {{ (old('reincidencia') == 'Reincidente' ? 'selected' : '') }}>
                                            Reincidente
                                        </option>
                                        <option value="N/C" {{ (old('reincidencia') == 'N/C' ? 'selected' : '') }}>N/C
                                        </option>
                                    </select>
                                </label>
                            </div>
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="origem_processo" class="select2">
                                        <option
                                            value="Justica Militar" {{ (old('origem_processo') == 'Justica Militar' ? 'selected' : '') }}>
                                            Justica Militar
                                        </option>
                                        <option
                                            value="Justica Comum" {{ (old('origem_processo') == 'Justica Comum' ? 'selected' : '') }}>
                                            Justica Comum
                                        </option>
                                        <option
                                            value="Justica Federal" {{ (old('origem_processo') == 'Justica federal' ? 'selected' : '') }}>
                                            Justica Federal
                                        </option>
                                    </select>
                                </label>
                            ...
                            <div class="label_g2">
                                ...
                                <label class="label">
                                    ...
                                    <input type="text" name="exticao_punibilidade" placeholder="Extinção"
                                           value="{{ old('exticao_punibilidade')}}"/>
                                </label>
                            </div>
                        </div>
                    </div>
