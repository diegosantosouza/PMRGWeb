    ...
    <div class="dash_login_left">
        <article class="dash_login_left_box">
            <header class="dash_login_box_headline">
                ...
                <h1 class="text-orange">PMRG Web</h1>
            </header>
            ...
            <form name="login" action="{{ route('admin.login.do') }}" method="post" autocomplete="off">
                ...
                <h4 class="mt-2"> <a href="{{ route('admin.register') }}" class="text-orange mx-0">Solicitar acesso</a> <a href="{{ route('admin.reset') }}" class="mx-2 text-orange ">Esqueceu sua senha?</a></h4>
