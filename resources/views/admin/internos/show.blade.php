    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            ...
            <div class="nav">
                ...
                <ul class="nav_tabs">
                    ...
                    <li class="nav_tabs_item">
                        <a href="#comportamento" class="nav_tabs_item_link">Comportamento <span
                                class="badge badge-success right">{{$interno->comportamento_count}}</span></a>
                    </li>
                </ul>

                <form class="app_form" action="" method="post" enctype="multipart/form-data" id="formulario">
                        ...
                        <div id="dados_cadastrais">
                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <input type="text" name="orientacao_sexual"
                                           value="{{$interno->orientacao_sexual}}"/>
                                </label>
                            </div>
                            ...
                            <div class="label_g4">
                                <label class="label">
                                    ...
                                    <input type="tel" name="nascimento" class=""
                                           value="{{$interno->nascimento}} {{' '.$idade->y .' anos'}}"/>
                                </label>
                                ...
                                <div class="app_collapse_content d-none">
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="defeitos_fisicos"
                                                   value="{{$interno->defeitos_fisicos }}"/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="sinais_nascenca"
                                                   value="{{$interno->sinais_nascenca}}"/>
                                        </label>
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="acidente_doenca_morte"
                                                   ...
                                                   value="{{$interno->acidente_doenca_morte}}"/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="batalhao_cidade"
                                                   value="{{$interno->batalhao_cidade}}"/>
                                        </label>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="admissao" class="mask-date"
                                                   value="{{$interno->admissao}}"/>
                                        </label>

                                        <label class="label">
                                            <span class="legend">Demissao:</span>
                                            <input type="tel" name="demissao" class="mask-date"
                                                   value="{{$interno->demissao}}"/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="app_collapse_content">
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="tel" name="created_at" class="mask-date"
                                                   placeholder="Data de inclusão" value="{{$interno->created_at}}"/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="assistencia_juridica"
                                                   value="{{$interno->assistencia_juridica}}"/>
                                        </label>

                                        <label class="label">
                                            <span class="legend">Procedência:</span>
                                            <input type="text" name="procedencia" placeholder="Procedência"
                                                   value="{{$interno->procedencia}}"/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="captura_procurado"
                                                   value="{{$interno->captura_procurado}}"/>
                                        </label>


                                        <label class="label">
                                            <span class="legend">Captura Estado:</span>
                                            <input type="text" name="captura_estado"
                                                   value="{{$interno->captura_estado}}"/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="sit_anterior_prisao"
                                                   value="{{$interno->sit_anterior_prisao}}"/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2 mt-1">
                                        <label class="label">
                                            ...
                                            <input type="tel" name="data_liberdade_remocao" class="mask-date"
                                                   ...
                                                   value="{{$interno->data_liberdade_remocao}}"/>
                                        </label>
                                ...
                                <div class="label_g2 mt-1">
                                    <label class="label">
                                        ...
                                        <input type="text" name="instituicao_ensino"
                                               value="{{$interno->ensino->instituicao_ensino}}"/>
                                    </label>

                                    <label class="label">
                                        <span class="legend">Horáro:</span>
                                        <input type="text" name="horario_semana"
                                               value="{{ 'seg-sex: '.$interno->ensino->horario_semana. ', '. 'sáb-dom: ' . $interno->ensino->horario_fim_semana}}"/>
                                    </label>
                                </div>
                            @else
                                <div class="no-content">Não foram encontrados registros!</div>
                                ...
                                <div class="label_g2 mt-1">
                                    <label class="label">
                                        ...
                                        <input type="text" name="empregador"
                                               value="{{$interno->trabalho->empregador}}"/>
                                    </label>

                                    <label class="label">
                                        <span class="legend">Horáro:</span>
                                        <input type="text" name="horario_semana"
                                               value="{{ 'seg-sex: '.$interno->trabalho->horario_semana. ', '. 'sáb-dom: ' . $interno->trabalho->horario_fim_semana}}"/>
                                    </label>
                                </div>
                            @else
                                <div class="no-content">Não foram encontrados registros!</div>
                        ...
                        <div id="comportamento" class="d-none">
                            <div class="label_g2 mt-1">
                                <label class="label">
                                    ...
                                    <input type="text" name="comportamento_status"
                                           value="{{$interno->comportamento_status}}"/>
                                </label>
                                <label class="label">
                                    <span class="legend">Até Data:</span>
                                    <input type="text" name="comportamento_data"
                                           value="{{$interno->comportamento_data}}"/>
                                </label>
                            </div>
                            @if(\Illuminate\Support\Facades\Auth::user()->pjmd == 1)
                                <a class="btn btn-green icon-pencil"
                                   href="{{ route('pjmd.comportamentoEdit', ['pjmd'=>$interno->id]) }}">Editar</a>
                            @endif
                                        ...
                                        <div class="app_collapse_content d-none">
                                            ...
                                            <div class="label_g2">
                                                <label class="label">
                                                    ...
                                                    <input type="text" name="pdi_status"
                                                           value="{{ $comportamento->pdi_status}}"/>
                                                </label>
                                            ...
                                            <div class="label_g2">
                                                <label class="label">
                                                    ...
                                                    <input type="tel" name="data_inicio" class="mask-date"
                                                           value="{{ $comportamento->data_inicio }}"/>
                                                </label>

                                                <label class="label">
                                                    <span class="legend">*Data de Término:</span>
                                                    <input type="tel" name="data_termino" class="mask-date"
                                                           value="{{ $comportamento->data_termino }}"/>
                                                </label>
                                            </div>
                                            ...
                                            <div class="label_g5">
                                                <label class="label">
                                                    ...
                                                    <textarea name="assunto"
                                                              rows="5">{{$comportamento->assunto}}</textarea>
                                                </label>
                                            </div>
                                            ...
                                            <div class="label_g5">
                                                <label class="label">
                                                    ...
                                                    <textarea name="punicao"
                                                              rows="5">{{$comportamento->punicao}}</textarea>
                                                </label>
                                            </div>
                                            ...
                                            <label class="label">
                                                ...
                                                @if(!empty($comportamento->arquivos))
                                                    @foreach($comportamento->arquivos as $documento)
                                                        <div class="mt-1">
                                                            <a target="_blank"
                                                               href="{{asset('storage/'.$documento->path)}}"
                                                               class="text-orange">{{\Illuminate\Support\Str::afterLast($documento->path, '/')}}</a>
                                                            <hr>
                                                        </div>
                                                    @endforeach
        ...
        <form class="app_form" action="{{route('gerar.internofichaPDF',['id'=>$interno->id])}}" target="_blank"
            ...
            <div class="actions text-right mt-2">
                <button class="icon-print btn btn-large btn-orange" type="submit">Imprimir</button>
            </div>
        </form>
