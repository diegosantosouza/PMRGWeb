    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            <div class="nav">
                ...
                <form class="app_form" action="{{ route('internos.update', ['interno'=>$interno->id]) }}" method="post"
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <input type="text" name="endereco"
                                                   placeholder="Rua, nº, complemento" class="firstuppercase"
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <select name="patente" class="select2">
                                                ...
                                                <option
                                                    value="Ex Coronel PM" {{ (old('patente') == 'Ex Coronel PM' ? 'selected' : ($interno->patente == 'Ex Coronel PM' ? 'selected' :'' )) }}>
                                                    Ex Coronel PM
                                                </option>
                                                <option
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="n" class="select2">
                                                <option
                                                    value="{{$interno->n}}" {{ (old('n') == $interno->n ? 'selected' : '') }}>{{$interno->n}}</option>
                            ...
                            @if(!empty($interno->processos))
                                @foreach($interno->processos as $processo)
                                    <div class="app_collapse">
                                        ...
                                        <div class="app_collapse_header collapse">
                                            <div>
                                                <h3>@if(!empty($processo->processo_de_execucao))
                                                        Proc. Exec. Nº {{$processo->processo_de_execucao}}
                                                    @else
                                                        Nº Inquérito {{$processo->n_inquerito}}
                                                    @endif</h3>
                                                @if(!empty($processo->processo_referencia))<i class="text-orange">Proc.
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{route('internos.destroy', ['interno'=>$interno->id])}}" method="post" class="">
                        @csrf
                        @method('DELETE')
