...
<section class="dash_content_app">
    ...
    <header class="dash_content_app_header">
        <h2 class="icon-book">Criar Estudo</h2>
    ...
    <div class="dash_content_app_box">
        <div class="nav">
            ...
            <form class="app_form" action="{{ route('estudos.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div id="data">
                        ...
                        <div class="label_g4">
                            <label class="label">
                                ...
                                <input type="text" name="instituicao_ensino" placeholder="Nome da Instituição" value="{{ old('instituicao_ensino')}}"/>
                            </label>
