    ...
    <div class="dash_content_app_box">
        <div class="nav">
            ...
            <ul class="nav_tabs">
                ...
                <form class="app_form" action="{{ route('empregador.update', ['empregador'=>$empregador->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div id="data">
                            ...
                            <div class="label_g4">
                                <label class="label">
                                    ...
                                    <input type="text" name="empregador" placeholder="Nome do empregador" value="{{ old('instituicao_ensino') ?? $empregador->empregador}}"/>
                                </label>

                                <label class="label">
                                    <span class="legend">Horário seg. a sex.:</span>
                                    <input type="text" name="horario_semana" placeholder="Ex: 08:30/17:00" value="{{ old('horario_semana') ?? $empregador->horario_semana}}"/>
                                </label>

                                <label class="label">
                                    <span class="legend">Horário fim de semana:</span>
                                    <input type="text" name="horario_fim_semana" placeholder="Ex: 08:30/13:00" value="{{ old('horario_fim_semana') ?? $empregador->horario_fim_semana}}"/>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-2">
                        ...
                        <a type="button" id="myModal" class="btn btn-large btn-red icon-trash" data-toggle="modal" data-target="#deleteModal">Deletar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{route('empregador.destroy', ['empregador'=>$empregador->id])}}" method="post" class="">
                    @csrf
                    @method('DELETE')
